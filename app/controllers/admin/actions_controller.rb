  ...
  class ActionsController < Admin::BaseController
    ...
    def create
      ...
      if params["type"] == "users"
        process_users(file_data, days_count)
      else
        process_questions(file_data, days_count)
      end
    end

    private

    def process_users(file_data, days_count)
    ...
    def process_questions(file_data, days_count)
